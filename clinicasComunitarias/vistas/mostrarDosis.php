<?php
    ...
    $consultaClinicas="SELECT * FROM  dosis";
      ...
      <div class="pagecontain">
        <div class="div-block-6">
          ...
          <div class="contenido div-block-7 w-clearfix">
            <div class="row">
              <div class="col mb-5">
                <a class="agregar btn btn-success" href="#">Agregar nueva dosis</a>
              </div>
            </div>
            ...
            <tbody>
              ...
              while($filasClinicas = mysqli_fetch_array($cantidadClinicas))
                ...
                ?>
                    <tr>
                        <td><?php echo $filasClinicas['idDosis']?></td>
                        <td><?php echo $filasClinicas['nombreDosis']?></td>
                        <?php
                          if(0==0){
                            ?>

                        <td><a href="editarDosis.php?idDosis=<?php echo $filasClinicas['idDosis'] ?>" class="btn btn-info">Editar</a></td>
                        <td><a href="../includes/eliminarDosis.php?idDosis=<?php echo $filasClinicas['idDosis'] ?>" class="btn btn-danger">Eliminar</a></td>
                        <?php
                      }
                      else {
                        ?>
        ...
        <section class="modal">
            <div class="modal__container">
              <!-- nombre donacion ciudad direccion -->
                <h3 class="card-title">Agregar Dosis</h3>
                <form class="" action="../includes/insertarDosis.php" method="post">
                  <div class="row mb-4">
                    <div class="col">
                      <label for="">Nombre:</label>
                      <input class="form-control" type="text" name="nombreDosis" value="" required>
                    </div>
                  </div>
                  <div class="row">
                      <div class="col">
