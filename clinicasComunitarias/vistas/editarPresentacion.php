<?php
    ...
    $consultaClinicas="SELECT * FROM  presentacion WHERE idPresentacion='$idPresentacion'";
        ...
        <div class="div-block-6">
          ...
          <div class="contenido div-block-7 w-clearfix">
            <div class="col-md-3">
              ...
              <form class="" action="../includes/actualizarPresentacion.php" method="post">
                <div class="row mb-4">
                  <div class="col">
                    <label for="">Nombre:</label>
                    <input type="hidden" name="idPresentacion" value="<?php echo $filaClinica['idPresentacion'] ?>">
                    <input class="form-control" type="text" name="nombrePresentacion" value="<?php echo $filaClinica['nombrePresentacion'] ?>" required>
                  </div>
                </div>
                <div class="row">
                    <div class="col">
