<?php
    ...
    $idClinica=$_GET['idCiudad'];
    $consultaClinicas="SELECT * FROM  ciudades WHERE idCiudad='$idClinica'";
        ...
        <div class="div-block-6">
          ...
          <div class="contenido div-block-7 w-clearfix">
            <div class="col-md-3">
              ...
              <form class="" action="../includes/actualizarCiudad.php" method="post">
                <div class="row mb-5">
                  <div class="col">
                    <label for="">Nombre:</label>
                    <input type="hidden" name="idCiudad" value="<?php echo $filaClinica['idCiudad'] ?>">
                    <input class="form-control" type="text" name="nombreCiudad" value="<?php echo $filaClinica['nombreCiudad'] ?>" required>
                  </div>
                </div>
                <div class="row">
                    <div class="col">
