        ...
        <div class="div-block-6">
          ...
          <div class="contenido div-block-7 w-clearfix">
            <div class="col-md-3">
              ...
              <form class="" action="../includes/actualizarUsuario.php" method="post">
                <div class="row">
                  <div class="col">
                    <label for="">Nombre:</label>
                    <input type="hidden" name="idUsuario" value="<?php echo $filaClinica['idUsuario'] ?>">
                    <input class="form-control" type="text" name="nombreUsuario" value="<?php echo $filaClinica['nombreUsuario'] ?>" required>
                  </div>
                </div>
                <div class="row mb-4">
                  <div class="col">
                    <div class="col">
                      ...
                      <input class="form-control" type="password" name="claveUsuario" value="<?php echo $filaClinica['claveUsuario'] ?>" required>
                    </div>
                  </div>
                </div>
                <div class="row">
