<?php
    ...
    $consultaClinicas="SELECT * FROM  presentacion";
      ...
      <div class="pagecontain">
        <div class="div-block-6">
          ...
          <div class="contenido div-block-7 w-clearfix">
            <div class="row">
              <div class="col mb-5">
                <a class="agregar btn btn-success" href="#">Agregar nueva presentacion</a>
              </div>
            </div>
            ...
            <tbody>
              ...
              while($filasClinicas = mysqli_fetch_array($cantidadClinicas))
                ...
                ?>
                    <tr>
                        <td><?php echo $filasClinicas['idPresentacion']?></td>
                        <td><?php echo $filasClinicas['nombrePresentacion']?></td>
                        <?php
                          if(0==0){
                            ?>

                        <td><a href="editarPresentacion.php?idPresentacion=<?php echo $filasClinicas['idPresentacion'] ?>" class="btn btn-info">Editar</a></td>
                        <td><a href="../includes/eliminarPresentacion.php?idPresentacion=<?php echo $filasClinicas['idPresentacion'] ?>" class="btn btn-danger">Eliminar</a></td>
                        <?php
                      }
                      else {
                        ?>
        ...
        <section class="modal">
            <div class="modal__container">
              <!-- nombre donacion ciudad direccion -->
                <h3 class="card-title">Agregar Presentacion</h3>
                <form class="" action="../includes/insertarPresentacion.php" method="post">
                  <div class="row mb-4">
                    <div class="col">
                      <label for="">Nombre:</label>
                      <input class="form-control" type="text" name="nombrePresentacion" value="" required>
                    </div>
                  </div>
                  <div class="row">
                      <div class="col">
